...
//        tableView.frame = CGRect(x: pointXY.x, y: pointXY.y + button.frame.height, width: button.frame.width, height: 0)
//        self.view.addSubview(tableView)
//        tableView.layer.cornerRadius = 5
//
//        transparentView.backgroundColor = UIColor.black.withAlphaComponent(0.9)
...
//        UIView.animate(withDuration: 0.4, delay: 0.0, usingSpringWithDamping: 1.0, initialSpringVelocity: 1.0, options: .curveEaseInOut, animations: {
//            self.transparentView.alpha = 0.5
//            if self.subjectArray.count < 5 {
//                self.height = self.selectedButton.frame.height * CGFloat(self.subjectArray.count)
//            } else {
//                self.height = self.selectedButton.frame.height * 5
//            }
//            self.tableView.frame = CGRect(x: pointXY.x, y: pointXY.y + button.frame.height + 5, width: button.frame.width, height: self.height)
//        }, completion: nil)
//    }
